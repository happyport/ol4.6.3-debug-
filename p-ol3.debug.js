 var P = {
    ...
    ol.inherits(P.Event.PlotDrawEvent, ol.events.Event);
    ...
    P.PlotDraw.prototype.mapFirstClickHandler = function (e) {
        ...
        ol.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE,
            this.mapMouseMoveHandler, this, false);
    };
    ...
    P.PlotDraw.prototype.disconnectEventHandlers = function () {
        ...
        ol.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEMOVE,
    ...
    P.PlotEdit.prototype.controlPointMouseDownHandler = function (e) {
        ...
        ol.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, this, false);
        ol.events.listen(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, this, false);
    };
    ...
    P.PlotEdit.prototype.controlPointMouseUpHandler = function (e) {
        ...
        ol.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEUP,
